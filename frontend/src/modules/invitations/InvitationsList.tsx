...
export const InvitationsList: React.FC = () => {
  ...
  const checkedInCount = eventInvites.filter((i) => i.checked_in).length;
  ...
  return (
    <div style={{ padding: '24px', maxWidth: '1400px', margin: '0 auto', color: 'var(--color-text-primary)' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: '16px', marginBottom: '28px' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
          <button
            ...
            style={{ padding: '10px 18px', background: 'linear-gradient(135deg, #2563EB 0%, #1D4ED8 100%)', color: '#FFF', border: 'none', borderRadius: '12px', fontWeight: 700, cursor: 'pointer', fontSize: '13px', display: 'flex', alignItems: 'center', gap: '6px', boxShadow: '0 4px 12px rgba(37,99,235,0.25)' }}
          >
          ...
          <button
            ...
            style={{ padding: '10px 18px', background: 'linear-gradient(135deg, #10B981 0%, #059669 100%)', color: '#FFF', border: 'none', borderRadius: '12px', fontWeight: 700, cursor: 'pointer', fontSize: '13px', display: 'flex', alignItems: 'center', gap: '6px', boxShadow: '0 4px 12px rgba(16,185,129,0.25)' }}
          >
            <QrCode size={16} /> Gate Scanner
          </button>
          <button
            onClick={handleExportExcel}
            style={{ padding: '10px 16px', background: 'var(--color-bg-card)', color: 'var(--color-text-primary)', border: '1px solid var(--color-border)', borderRadius: '12px', fontWeight: 700, cursor: 'pointer', fontSize: '13px', display: 'flex', alignItems: 'center', gap: '6px' }}
          >
            <FileSpreadsheet size={16} style={{ color: '#059669' }} /> Export
          </button>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '16px', marginBottom: '28px' }}>
        <div style={{ background: 'var(--color-bg-card)', borderRadius: '16px', padding: '18px 20px', border: '1px solid var(--color-border)', borderLeft: '4px solid #F59E0B', boxShadow: '0 4px 12px rgba(0,0,0,0.06)', display: 'flex', alignItems: 'center', gap: '16px' }}>
          <div style={{ padding: '12px', borderRadius: '12px', background: 'rgba(245,158,11,0.12)', color: '#D97706' }}>
            <Clock size={24} />
          </div>
          <div>
            <span style={{ fontSize: '12px', color: 'var(--color-text-secondary)', fontWeight: 600 }}>Pending Onboarding</span>
            <div style={{ fontSize: '24px', fontWeight: 900, color: 'var(--color-text-primary)' }}>{pendingCount}</div>
          </div>
        </div>

        <div style={{ background: 'var(--color-bg-card)', borderRadius: '16px', padding: '18px 20px', border: '1px solid var(--color-border)', borderLeft: '4px solid #10B981', boxShadow: '0 4px 12px rgba(0,0,0,0.06)', display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '24px', fontWeight: 900, color: 'var(--color-text-primary)' }}>{acceptedCount}</div>
          </div>
        </div>

        <div style={{ background: 'var(--color-bg-card)', borderRadius: '16px', padding: '18px 20px', border: '1px solid var(--color-border)', borderLeft: '4px solid #7C3AED', boxShadow: '0 4px 12px rgba(0,0,0,0.06)', display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '24px', fontWeight: 900, color: 'var(--color-text-primary)' }}>{attendingRsvpCount}</div>
          </div>
        </div>

        <div style={{ background: 'var(--color-bg-card)', borderRadius: '16px', padding: '18px 20px', border: '1px solid var(--color-border)', borderLeft: '4px solid #3B82F6', boxShadow: '0 4px 12px rgba(0,0,0,0.06)', display: 'flex', alignItems: 'center', gap: '16px' }}>
          <div style={{ padding: '12px', borderRadius: '12px', background: 'rgba(59,130,246,0.12)', color: '#3B82F6' }}>
            <Ticket size={24} />
          </div>
          <div>
            <span style={{ fontSize: '12px', color: 'var(--color-text-secondary)', fontWeight: 600 }}>Gate Checked-in Passes</span>
            <div style={{ fontSize: '24px', fontWeight: 900, color: 'var(--color-text-primary)' }}>{checkedInCount}</div>
          </div>
        </div>
      </div>

      {/* Tabs Bar, Filters & View Mode Switcher */}
      <div style={{ background: 'var(--color-bg-card)', borderRadius: '20px', border: '1px solid var(--color-border)', padding: '16px 20px', marginBottom: '24px', boxShadow: '0 4px 12px rgba(0,0,0,0.03)' }}>
        <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', background: 'var(--color-bg)', padding: '4px', borderRadius: '14px', border: '1px solid var(--color-border)' }}>
            ...
            >
              <Sparkles size={16} style={{ color: activeTab === 'events' ? '#FDE047' : '#7C3AED' }} /> Event Patrikas ({eventInvites.length})
            </button>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
            <div style={{ position: 'relative', minWidth: '220px' }}>
              ...
              <input
                ...
                style={{ width: '100%', padding: '8px 12px 8px 38px', background: 'var(--color-bg)', border: '1px solid var(--color-border)', borderRadius: '10px', color: 'var(--color-text-primary)', fontSize: '13px', outline: 'none' }}
              />
            </div>
            ...
            <select
              ...
              style={{ padding: '8px 12px', background: 'var(--color-bg)', border: '1px solid var(--color-border)', borderRadius: '10px', color: 'var(--color-text-primary)', fontSize: '13px', outline: 'none' }}
            >
            ...
            <div style={{ display: 'flex', background: 'var(--color-bg)', padding: '3px', borderRadius: '10px', border: '1px solid var(--color-border)' }}>
              <button
                ...
                style={{
                  ...
                  color: viewMode === 'grid' ? '#2563EB' : 'var(--color-text-secondary)',
                  cursor: 'pointer',
                  display: 'flex',
                  alignItems: 'center',
              ...
              <button
                ...
                style={{
                  ...
                  color: viewMode === 'table' ? '#2563EB' : 'var(--color-text-secondary)',
                  cursor: 'pointer',
                  display: 'flex',
                  alignItems: 'center',
      ...
      {loading ? (
        ...
        viewMode === 'grid' ? (
          /* Grid Cards View for Team Invites */
          filteredUserInvites.length === 0 ? (
            <div style={{ textAlign: 'center', padding: '48px 20px', color: 'var(--color-text-secondary)', background: 'var(--color-bg-card)', borderRadius: '20px', border: '1px solid var(--color-border)' }}>
              ...
              {filteredUserInvites.map((inv) => (
                <div
                  ...
                  style={{
                    ...
                    borderLeft: inv.status === 'accepted' ? '4px solid #10B981' : inv.status === 'pending' ? '4px solid #F59E0B' : '4px solid #94A3B8',
                    padding: '18px',
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '10px' }}>
                    <div>
                      <h4 style={{ margin: 0, fontSize: '16px', fontWeight: 800, color: 'var(--color-text-primary)' }}>
                        {inv.full_name || 'Unnamed Recipient'}
                      </h4>
                      <div style={{ fontSize: '12px', color: 'var(--color-text-secondary)', marginTop: '2px' }}>{inv.email}</div>
                    </div>
                    {inv.status === 'pending' && <span style={{ background: 'rgba(245,158,11,0.15)', color: '#D97706', border: '1px solid #F59E0B', padding: '3px 8px', borderRadius: '10px', fontSize: '11px', fontWeight: 700 }}>⏳ Pending</span>}
                    {inv.status === 'accepted' && <span style={{ background: 'rgba(34,197,94,0.15)', color: '#16A34A', border: '1px solid #22C55E', padding: '3px 8px', borderRadius: '10px', fontSize: '11px', fontWeight: 700 }}>✓ Accepted</span>}
                    {inv.status === 'expired' && <span style={{ background: 'rgba(239,68,68,0.15)', color: '#DC2626', border: '1px solid #EF4444', padding: '3px 8px', borderRadius: '10px', fontSize: '11px', fontWeight: 700 }}>Expired</span>}
                    {inv.status === 'revoked' && <span style={{ background: 'rgba(100,116,139,0.15)', color: '#64748B', border: '1px solid #94A3B8', padding: '3px 8px', borderRadius: '10px', fontSize: '11px', fontWeight: 700 }}>Revoked</span>}
                  </div>

                  <div style={{ backgroundColor: 'var(--color-bg)', padding: '8px 12px', borderRadius: '10px', border: '1px solid var(--color-border)', marginBottom: '14px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <span style={{ fontSize: '12px', color: 'var(--color-text-secondary)' }}>Assigned Role:</span>
                    <span style={{ background: 'rgba(37,99,235,0.15)', color: '#3B82F6', padding: '2px 8px', borderRadius: '6px', fontSize: '11px', fontWeight: 700, textTransform: 'capitalize' }}>
                      {inv.role_name}
                    </span>
                  </div>

                  <div style={{ fontSize: '11px', color: 'var(--color-text-secondary)', marginBottom: '14px' }}>
                    📅 Expiry: {new Date(inv.expires_at).toLocaleDateString(undefined, { day: 'numeric', month: 'short', year: 'numeric' })}
                  </div>

                  <div style={{ marginTop: 'auto', paddingTop: '10px', borderTop: '1px solid var(--color-border)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '8px' }}>
                  ...
                  {filteredUserInvites.map((inv) => (
                    <tr key={inv.id} style={{ borderBottom: '1px solid var(--color-border)' }}>
                      <td style={{ padding: '16px 20px' }}>
                        ...
                        <span style={{ display: 'inline-block', marginTop: '4px', background: 'rgba(37,99,235,0.15)', color: '#3B82F6', padding: '2px 8px', borderRadius: '6px', fontSize: '11px', fontWeight: 700, textTransform: 'capitalize' }}>
                          {inv.role_name}
                        </span>
                      </td>

                      <td style={{ padding: '16px 20px' }}>
                        {inv.status === 'pending' && <span style={{ background: 'rgba(245,158,11,0.12)', color: '#D97706', border: '1px solid #F59E0B', padding: '4px 10px', borderRadius: '12px', fontSize: '11px', fontWeight: 700, textTransform: 'uppercase' }}>⏳ Pending</span>}
                        {inv.status === 'accepted' && <span style={{ background: 'rgba(34,197,94,0.12)', color: '#16A34A', border: '1px solid #22C55E', padding: '4px 10px', borderRadius: '12px', fontSize: '11px', fontWeight: 700, textTransform: 'uppercase' }}>✓ Accepted</span>}
                        {inv.status === 'expired' && <span style={{ background: 'rgba(239,68,68,0.12)', color: '#DC2626', border: '1px solid #EF4444', padding: '4px 10px', borderRadius: '12px', fontSize: '11px', fontWeight: 700, textTransform: 'uppercase' }}>Expired</span>}
                        {inv.status === 'revoked' && <span style={{ background: 'rgba(100,116,139,0.12)', color: '#64748B', border: '1px solid #94A3B8', padding: '4px 10px', borderRadius: '12px', fontSize: '11px', fontWeight: 700, textTransform: 'uppercase' }}>Revoked</span>}
                      </td>
        ...
        /* Event Patrikas & RSVP Tracker */
        viewMode === 'grid' ? (
          /* Grid Cards View for Event Patrikas */
              ...
              {filteredEventInvites.map((inv) => (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: '16px',
                    border: '1px solid var(--color-border)',
                    borderLeft: inv.checked_in ? '4px solid #10B981' : inv.rsvp_status === 'attending' ? '4px solid #7C3AED' : '4px solid #F59E0B',
                    padding: '18px',
                    boxShadow: '0 4px 12px rgba(0,0,0,0.06)',
                    display: 'flex',
                    flexDirection: 'column',
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8px' }}>
                    <div>
                      ...
                      <div style={{ fontSize: '12px', color: 'var(--color-text-secondary)', marginTop: '2px' }}>{inv.title}</div>
                    </div>
                    <span style={{ background: 'rgba(124,58,237,0.15)', color: '#A855F7', padding: '3px 8px', borderRadius: '8px', fontSize: '11px', fontWeight: 700 }}>
                      ✨ {inv.vip_tier}
                    </span>
                  </div>

                  <div style={{ backgroundColor: 'var(--color-bg)', padding: '10px 12px', borderRadius: '10px', border: '1px solid var(--color-border)', marginBottom: '12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div style={{ fontSize: '12px', color: 'var(--color-text-primary)', fontWeight: 700 }}>
                      👥 {inv.guests_count} Attendees
                    </div>
                    {inv.rsvp_status === 'attending' && <span style={{ background: 'rgba(34,197,94,0.15)', color: '#16A34A', border: '1px solid #22C55E', padding: '3px 8px', borderRadius: '10px', fontSize: '11px', fontWeight: 700 }}>✓ Attending</span>}
                    {inv.rsvp_status === 'pending' && <span style={{ background: 'rgba(245,158,11,0.15)', color: '#D97706', border: '1px solid #F59E0B', padding: '3px 8px', borderRadius: '10px', fontSize: '11px', fontWeight: 700 }}>Pending RSVP</span>}
                    {inv.rsvp_status === 'maybe' && <span style={{ background: 'rgba(37,99,235,0.15)', color: '#2563EB', border: '1px solid #3B82F6', padding: '3px 8px', borderRadius: '10px', fontSize: '11px', fontWeight: 700 }}>Maybe</span>}
                    {inv.rsvp_status === 'declined' && <span style={{ background: 'rgba(239,68,68,0.15)', color: '#DC2626', border: '1px solid #EF4444', padding: '3px 8px', borderRadius: '10px', fontSize: '11px', fontWeight: 700 }}>Declined</span>}
                  </div>

                  {inv.checked_in ? (
                    <div style={{ background: 'rgba(16,185,129,0.1)', color: '#16A34A', border: '1px solid rgba(16,185,129,0.3)', padding: '6px 10px', borderRadius: '8px', fontSize: '11px', fontWeight: 700, marginBottom: '14px', display: 'flex', alignItems: 'center', gap: '6px' }}>
                      <CheckCircle2 size={14} /> Checked In ({new Date(inv.checked_in_at!).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })})
                    </div>
                  ) : (
                    <div style={{ color: 'var(--color-text-secondary)', fontSize: '11px', marginBottom: '14px' }}>
                      🎟️ Gate Ticket Pass Active
                    </div>
                  )}
                  ...
                  <div style={{ marginTop: 'auto', paddingTop: '10px', borderTop: '1px solid var(--color-border)' }}>
                    <button
                      ...
                      style={{ width: '100%', padding: '8px', background: 'linear-gradient(135deg, #7C3AED 0%, #6D28D9 100%)', color: '#FFF', border: 'none', borderRadius: '10px', cursor: 'pointer', fontSize: '12px', fontWeight: 700, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}
                    >
                      <Copy size={14} /> Copy Digital Patrika URL
                    </button>
                  </div>
                </div>
              ))}
                ...
                <tbody>
                  {filteredEventInvites.map((inv) => (
                    <tr key={inv.id} style={{ borderBottom: '1px solid var(--color-border)' }}>
                      ...
                      <td style={{ padding: '16px 20px' }}>
                        {inv.rsvp_status === 'attending' && <span style={{ background: 'rgba(34,197,94,0.12)', color: '#16A34A', border: '1px solid #22C55E', padding: '4px 10px', borderRadius: '12px', fontSize: '11px', fontWeight: 700, textTransform: 'uppercase' }}>✓ Attending</span>}
                        {inv.rsvp_status === 'pending' && <span style={{ background: 'rgba(245,158,11,0.12)', color: '#D97706', border: '1px solid #F59E0B', padding: '4px 10px', borderRadius: '12px', fontSize: '11px', fontWeight: 700, textTransform: 'uppercase' }}>Pending RSVP</span>}
                        {inv.rsvp_status === 'maybe' && <span style={{ background: 'rgba(37,99,235,0.12)', color: '#2563EB', border: '1px solid #3B82F6', padding: '4px 10px', borderRadius: '12px', fontSize: '11px', fontWeight: 700, textTransform: 'uppercase' }}>Maybe</span>}
                        {inv.rsvp_status === 'declined' && <span style={{ background: 'rgba(239,68,68,0.12)', color: '#DC2626', border: '1px solid #EF4444', padding: '4px 10px', borderRadius: '12px', fontSize: '11px', fontWeight: 700, textTransform: 'uppercase' }}>Declined</span>}
                      </td>
