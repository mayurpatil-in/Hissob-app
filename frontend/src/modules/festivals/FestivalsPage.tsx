...
const FestivalsPage: React.FC = () => {
  ...
  const columns = [
      ...
      render: (name: string, record: any) => {
        ...
        return (
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div>
              <b style={{ color: 'var(--color-text-primary)', fontSize: 14 }}>{name}</b>
              {record.description && (
    ...
    },
    {
      ...
      key: 'location',
      render: (loc: string) => (
        <span style={{ fontSize: 12, color: 'var(--color-text-secondary, #94A3B8)', fontWeight: 600 }}>
    ...
    },
    {
      ...
      key: 'duration',
      render: (_: any, r: any) => (
        <span style={{ fontSize: 12, whiteSpace: 'nowrap', color: 'var(--color-text-secondary, #94A3B8)', fontWeight: 500 }}>
