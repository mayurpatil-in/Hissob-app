...
def send_raw_email(
    ...
    try:
        ...
        encoded_from = formataddr((str(Header(sender_display, "utf-8")), settings.SMTP_FROM_EMAIL))
        ...
        if attachments:
            ...
            for filename, file_bytes, _m_type in attachments:
                ...
                att_part.add_header("Content-Disposition", "attachment", filename=("utf-8", "", filename))
                msg.attach(att_part)
        else:
